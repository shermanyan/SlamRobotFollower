...
class ObstacleFreeWaypointController:
    def __init__(self, waypoints: List[Dict]):
        ...
        self.linear_controller = PIDController(0.5, 0.1, 0.1, 10, -0.1, 0.1)
        self.angular_controller = PIDController(0.8, 0.5, 0.5, 10, -2, 2)
...
class ObstacleAvoidingWaypointController:
    def __init__(self, waypoints: List[Dict]):
        ...
        self.wp_linear_controller = PIDController(0.8, 0.1, 0.1, 10, -0.1, 0.1)
    ...
    def control_robot(self):
        ...
        while not rospy.is_shutdown():
            ...
            distances = self.laserscan_distances_to_point(goal_position, radians(10))
